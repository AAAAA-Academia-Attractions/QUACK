...
# Background — clean dark slate
BACKGROUND_COLOR = (20, 24, 34)

# Map elements (schematic / blueprint palette)
ROOM_FILL = (228, 233, 242)
ROOM_FILL_CURRENT = (200, 220, 248)
ROOM_BORDER = (72, 96, 130)
ROOM_BORDER_CURRENT = (45, 110, 210)
ROOM_TITLE_BG = (32, 42, 58)
CORRIDOR_COLOR = (88, 108, 138)
CORRIDOR_COLOR_DIM = (52, 58, 72)
WEIGHT_BADGE_FILL = (38, 46, 62)
WEIGHT_BADGE_BORDER = (120, 140, 175)
...
# Dead player POV (god-view personal strip)
DEAD_POV_TITLE_BG = (42, 44, 50)
DEAD_POV_TITLE_TEXT = (130, 130, 140)
...
# Layout — moderate resolution, typography-first
GOD_VIEW_SCALE = 1.55
